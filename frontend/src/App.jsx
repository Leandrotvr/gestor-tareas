...
const API = "https://gestor-tareas-api-ra7s.onrender.com/api"; console.log('API =', API); console.log('API =', API); console.log('API =', API); console.log('API =', API); console.log('API =', API); console.log('API =', API); console.log("API =", API);
